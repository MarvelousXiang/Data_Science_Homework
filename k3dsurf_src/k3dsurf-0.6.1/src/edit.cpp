...
editeur::editeur()
    : QMainWindow( 0, "editeur", WDestructiveClose )
{
    workfile = "test.pov";
...
/*
    ...
    runIcon = QPixmap( "run.xpm" );
    QToolButton * fileRun
	= new QToolButton( runIcon, tr("Run Pov"), QString::null,
			   this, SLOT(runpovray()), fileTools, "print file" );
*/
...
//    QWhatsThis::add( filePrint, filePrintText );
    ...
    // QWhatsThis::add( fileRun, filePrintText );
...
*/
    ...
    e = new QTextEdit( this, "editeuror" );
    e->setFocus();
    setCentralWidget( e );
...
{
    //e->setPaper(QBrush(QColor(0,0,0)));
    e->append(txt );
}
...
void editeur::runpovray()
{
   ...
   //system("xterm&");
/*
if(workfile == "commencement" || workfile == "OBJECT.POV") {
   QMessageBox message ;
    
    message.setText(tr("Please save this file once..."));
    message.adjustSize () ;
    message.exec();
...
*/
system("povray +I"+workfile+" +Oscene.tga +L/root/Desktop/pov/povray-3.6.1/scenes/incdemo/glasses  +FT +W250 +H250 +P +X10 &");
